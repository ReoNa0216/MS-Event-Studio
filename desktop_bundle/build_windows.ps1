...
if (!$Version) {
    $Version = if ($env:MS_EVENT_STUDIO_VERSION) { $env:MS_EVENT_STUDIO_VERSION } else { "0.6.1rc1" }
}
...
Remove-Item -LiteralPath Env:FLAME_FEATURE_CORE_020_WHEEL_BASE64 -ErrorAction SilentlyContinue
